...
/*
  TODO 5.2.1: Import the fetchAircraftWithPagination function from the Aircraft CRUD methods
*/
    ...
    const loadPaginatedAircraft = async () => {
      ...
      try {
        ...
        */
        ...
        const data = await fetchAircraftWithPagination(baseId, PAGE_SIZE, page * PAGE_SIZE);
